...
Use a 90 degree angle wall to see how long it takes to make a quarter turn.
check the distance sensor to see when the turn goes too far, use that to calibrate the rotating
