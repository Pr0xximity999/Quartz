...
Here's a helpful diagram to estimate their resistance:<br>![[00 - 09 Vault Administration/02 - Attachments/Pasted image 20250903145215.png]]
...
## Symbol in a diagram
A diode is depicted by a triangle with a stripe on the tip:<br>![[00 - 09 Vault Administration/02 - Attachments/Pasted image 20250903150124.png]]

The flow comes in on the positive side (the anode) and flows out of the negative side (the cathode)
# Light Emitting Diode (LED)
An LED is a diode that emits light (shocker). Because a led is an anode, it only works one way. Knowing which end is the anode and cathode is very simple: *the long end is the anode, and short end the cathode.*<br>![[00 - 09 Vault Administration/02 - Attachments/Pasted image 20250903150346.png]]
...
![[00 - 09 Vault Administration/02 - Attachments/Pasted image 20250903145455.png]]

The two outside columns are connected vertically, and every middle column is connected horizontally: <br>![[00 - 09 Vault Administration/02 - Attachments/Pasted image 20250903145547.png]]
