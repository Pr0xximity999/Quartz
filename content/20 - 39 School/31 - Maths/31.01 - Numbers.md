...
## Rational numbers
Rational numbers are integers that can be written like a [[20 - 39 School/31 - Maths/31.05 - The quotient, fractions, ratios and percentages#Fractions|fraction]] (a/b) whose denominator is *not* zero. For example: $5$ can be written as $\frac{5}{1}$ and thus is a rational number.
...
>[!note] next chapter
>The next chapter will go over [[20 - 39 School/31 - Maths/31.02 - Ordering of integers|Ordering of integers]]
