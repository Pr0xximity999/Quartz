...
Sometimes, the quotient is defined as the greatest *whole number* of times a divisor can be subtracted from a dividend before the remainder is negative. If this is the case, the quotient of two numbers is always an integer itself
