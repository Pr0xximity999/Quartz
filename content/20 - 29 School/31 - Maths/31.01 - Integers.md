...
# Rational numbers
Rational numbers are numbers that can be written like a [[20 - 29 School/31 - Maths/31.05 - The quotient and fractions#Fractions|fraction]] (a/b), whose denominator is *not* zero. For example: $5\div8$ can be written as $\frac{5}{8}$ and thus is a rational number.
