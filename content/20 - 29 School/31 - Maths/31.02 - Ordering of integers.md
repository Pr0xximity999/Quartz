...
tags:
  ...
  - maths/operators
---
In the previous chapter we talked about [[20 - 29 School/31 - Maths/31.01 - Integers (whole numbers)|integers]], let's expand on that.
...
1. write both numbers below each other:
	$256477,256486$
...
3. Compare top and bottom to see which of the two is either greater or less (depending on your goal):
	$\boxed{2564}77$
	$\boxed{2564}86$
	$7 < 8$ Or $8 > 7$

4. Now write the whole numbers again:
	$256477 < 256486$ Or $256486 > 256477$


>[!note] next chapter
>The next chapter will go over [[20 - 29 School/31 - Maths/31.03 - Sum, difference, product and quotient|the sum, difference, product and quotient of numbers]]