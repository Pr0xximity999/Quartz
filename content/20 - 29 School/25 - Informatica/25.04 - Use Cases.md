...
Een use case beschrijft een interactie tussen de gebruiker en het systeem voor een specifieke functionaliteit van het systeem. Het is deel van het Universal Modeling Language (UML), net zoals een [[20 - 29 School/25 - Informatica/25.07 - Class Diagrams|klasse diagram]].
