...
>2. Voer een dynamische test (DAST) uit met behulp van de tool ZAP. Pak hiervoor een eigen website of een website met een bounty programma (of je school). Maak een rapport van de 5 grootste bevindingen en geef een advies om het op te lossen.
