...
For [[School/27 - Software Development/26.03 - Object Oriented Programming|Object Oriented Programming]], this is knowing which classes interact with which and what methods these classes contain.
One way of doing this is via modelling it in a subset of the Unified Modeling language(UML) called class diagrams.
Another type of UML diagram is a [[School/25 - Informatica/25.04 - Use Cases and Diagrams|use case diagram]]
