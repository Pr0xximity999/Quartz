...
Unlike [[School/25 - Informatica/25.07 - Class Diagrams|class diagrams]], [[School/25 - Informatica/25.04 - Use Cases and Diagrams|use case diagrams]] and [[School/25 - Informatica/25.10 - Activity diagrams|activity diagrams]], ERD's are not part of the UML language. ERD's are its own type of diagram, while UML is a type of making diagrams.
