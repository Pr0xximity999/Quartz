...
The object file will now be put trough a linker to link it with the right external libraries. The assembly instructions will differ depending on your OS's libraries (windows has different ones from Linux, etc..), and thus you need to link them to the right one.
...
> [[10 - 19 Personal projects/12 - Compiler/12.02 Setting up the project|For the next step well set up the project]]
